...
const Content2 = ({ className, ...rest }) => {
  ...
  const contentWidgetData = [
    {
      icon: img1,
      title: "Contacto remoto",
      text: "Puedes contactarnos por teléfono o email desde donde necesites.",
    },
    {
      icon: img2,
      title: "Rápida comunicación",
      text: "Nos pondremos en contacto contigo lo antes posible para solucionar tus dudas.",
    },
    {
      icon: img3,
      title: "Pagos seguros",
      text: "Te explicamos todas las condiciones para que no haya sorpresas en tus facturas.",
    },
  ];
  return (
    <>
